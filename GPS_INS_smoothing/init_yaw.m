% This function initialize yaw angle with phase measurements, by
% considering the difference of two sequential phase measurements (Doppler) as the
% measurement of velocity. The flow of this function is
